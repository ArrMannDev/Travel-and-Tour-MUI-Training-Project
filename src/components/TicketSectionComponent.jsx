        ...
        <Box key={flight.id} sx={{ mb: 5 }}>
          ...
          >
            ...
            >
              ...
              <Box sx={{ textAlign: "center" }}>
                <Typography
                  variant="h5"
                  sx={{ color: "#c2915d", fontWeight: 500 }}
                >
          ...
          <Stack direction="row" spacing={4} ml={5}>
            <Button
              ...
              sx={{
                borderBottom:
                  activeTab === "flight" && activeFlightId === flight.id
                    ? "3px solid #57292B"
          ...
          {/* ===== Collapses ===== */}
          <Collapse
            in={activeTab === "flight" && activeFlightId === flight.id}
            timeout="auto"
            unmountOnExit
          >
          ...
          <Collapse
            in={activeTab === "farePackages" && activeFlightId === flight.id}
            timeout="auto"
            unmountOnExit
          >
          ...
          <Collapse
            in={activeTab === "fareBreakdown" && activeFlightId === flight.id}
            timeout="auto"
            unmountOnExit
          >
